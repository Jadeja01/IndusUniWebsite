  ...
  return (
    <>
      <div className="text-center py-4 bg-info bg-gradient">
        <h1 className="text-white mb-3">Indus University | Sheet-4</h1>
              ...
              <div className="card-body">
                ...
                <div className="mb-5">
                  ...
                  <p className="fw-bold mb-4">
                    Draw an Ellipse having major axis 120mm and minor axis 80mm. Use
                ...
                <div className="mb-5">
                  ...
                  <p className="fw-bold mb-4">
                    Draw an Ellipse having major axis 100 mm and minor axis 70 mm. Use
                ...
                <div className="mb-5">
                  ...
                  <p className="fw-bold mb-4">
                    Draw parabola with base 100 mm and axis 50 mm, 70° inclined from
                    base by using parallelogram method.
                  </p>
                  <div className="text-center">
                    <Image
                      src="/images/s4d3.jpg"
                ...
                <div className="mb-5">
                  ...
                  <p className="fw-bold mb-4">
                    Draw a curve having eccentricity 3:2, the focus F of which is at a
                    distance of 50mm from the directrix. Draw the curve and Name the
                    curve.
                  </p>
                  <div className="text-center">
                    <Image
