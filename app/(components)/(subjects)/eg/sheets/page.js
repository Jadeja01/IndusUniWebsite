...
export default function EngineeringGraphicsSheets() {
  return (
    <>
      <div
      ...
      >
        <h1 className="text-white mb-3">SWN | Engineering Graphics Sheets</h1>
      </div>
              ...
              {[1, 2, 3, 4, 5, 6, 7, 8].map((sheetNumber) => (
                <div key={sheetNumber} className="col-md-4 col-sm-6">
                  <div className="card shadow-sm h-100 sheet-card">
                    <div className="card-body text-center">
                      <Link
                        href={`/eg/sheets/sheet${sheetNumber}`}
                        className="text-decoration-none"
                      >
                        <Image
