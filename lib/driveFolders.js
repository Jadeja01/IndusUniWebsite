...
export const DRIVE_FOLDERS = {
  ...
  year1: {
    ...
    syllabus: process.env.DRIVE_YEAR1_SYLLABUS,
  ...
  year2: {
    ...
    syllabus: process.env.DRIVE_YEAR2_SYLLABUS,
  ...
  year3: {
    ...
    syllabus: process.env.DRIVE_YEAR3_SYLLABUS,
  ...
  year4: {
    ...
    syllabus: process.env.DRIVE_YEAR4_SYLLABUS,
